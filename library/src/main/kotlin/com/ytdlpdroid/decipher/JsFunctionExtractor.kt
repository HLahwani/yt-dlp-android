...
internal object JsFunctionExtractor {
    ...
    /**
     * Extracts the complete function source for [fnName] from [js].
     * Handles both `fnName=function(a){...}` and `function fnName(a){...}` forms.
     */
    ...
    /**
     * Extracts a `var name = { ... }` object literal from [js].
     */
